...
export const propertyItems: MockProperty[] = [
  {
    ...
    toll: {
      fees: {
        ...
        left: [
          ...
          { label: "مبلغ به حروف", value: "دو میلیون و چهارصد و پنجاه هزار تومان" },
        ],
      },
      history: [
    ...
    inquiry: {
      ...
      dimensions: [
        { dir: "شمال", type: "کوچه", name: "اخلاص", sideExist: "۱۰.۲۰", edgeExist: "۱۰.۲۰" },
        { dir: "شرق", type: "خیابان", name: "شهید سلیمانی", sideExist: "۲۱.۴۰", edgeExist: "۲۱.۴۰" },
        { dir: "جنوب", type: "کوچه", name: "گلستان", sideExist: "۱۰.۱۰", edgeExist: "۱۰.۱۰" },
        { dir: "غرب", type: "پلاک مجاور", name: "پلاک ۴۲", sideExist: "۲۱.۳۵", edgeExist: "۲۱.۳۵" },
      ],
    },
    requestTracking: {
      requests: [
  ...
  },
  {
    ...
    ownerName: "مریم علوی",
    description:
      "شماره پرونده: ۹۹۴۳۱، وضعیت ملک: آپارتمان، مساحت طبق سند: ۱۳۸۰ متر، پلاک ثبتی: ۱۸، آدرس: بلوار پیروزی، پلاک ۴",
    codes: {
      region: "7",
      neighborhood: "205",
      block: "12",
    ...
    owner: {
      ...
      address: "مراغه، بلوار پیروزی، پلاک ۴",
      ownerType: "حقیقی",
      fatherName: "رضا",
      birthPlace: "مراغه",
      issuePlace: "مراغه",
    ...
    guildFees: {
      title: "۷-۲۰۵-۱۲-۱۸-۱-۴-۰",
      type: "آپارتمان",
      feeInfo: {
        right: [
          { label: "نام متصدی", value: "مریم علوی" },
    ...
    inquiry: {
      ...
      dimensions: [
        { dir: "شمال", type: "خیابان", name: "آزادی", sideExist: "۱۵.۰۰", edgeExist: "۱۴.۵۰" },
        { dir: "شرق", type: "پلاک مجاور", name: "پلاک ۵", sideExist: "۲۰.۰۰", edgeExist: "۲۰.۰۰" },
        { dir: "جنوب", type: "کوچه", name: "یاس", sideExist: "۱۵.۱۰", edgeExist: "۱۴.۸۰" },
        { dir: "غرب", type: "پلاک مجاور", name: "پلاک ۷", sideExist: "۲۰.۰۵", edgeExist: "۲۰.۰۵" },
      ],
    },
    requestTracking: {
      requests: [
...
export const getStoredPropertyId = () => {
  ...
  return localStorage.getItem(selectedPropertyStorageKey) ?? getDefaultProperty().id;
};

          ...
          <div className="nav-shell">
            <div className="flex h-16 items-center justify-between gap-2 px-3 md:h-20 md:px-4">
              ...
              <div className="min-w-0 text-center">
                <h1 className="truncate text-sm font-bold text-foreground md:text-base">جزئیات خبر</h1>
              </div>
        ...
        <div className="container mx-auto max-w-4xl px-0 md:px-2 lg:px-6">
          {news ? (
            ...
            >
              ...
              <h2 className="text-xl font-black leading-9 text-foreground md:text-3xl md:leading-[1.9]">{news.title}</h2>
              <p className="mt-4 text-sm leading-7 text-muted-foreground md:text-base">{news.excerpt}</p>
            ...
            >
              <h2 className="text-xl font-black text-foreground md:text-2xl">خبر موردنظر پیدا نشد</h2>
              <p className="mt-3 text-sm leading-7 text-muted-foreground">
                ممکن است لینک تغییر کرده باشد یا خبر از فهرست اخیر حذف شده باشد.
              </p>
              <div className="mt-6">
                <Link to="/#news" className="btn-gradient inline-flex items-center gap-2 rounded-xl px-5 py-2.5 text-sm font-semibold text-primary-foreground">
                  <ArrowRight className="h-4 w-4" />
                  بازگشت به اخبار
                </Link>
              </div>

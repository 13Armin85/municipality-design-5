    ...
    >
      ...
      <main className="section-decor px-3 pb-12 pt-24 md:pb-20 md:pt-28 lg:px-6">
        <div className="container mx-auto max-w-6xl space-y-6">
          ...
          >
            کاربر گرامی، پس از انتخاب پرونده زیرمجموعه روی جستجو بزنید تا همه
            سکشن‌ها تکمیل شوند.
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2 p-4 md:grid-cols-8">
              <button
                ...
                className="h-11 rounded-xl bg-emerald-600 px-6 text-sm font-bold text-white transition-all hover:bg-emerald-700 active:scale-95"
              >
                جستجو
              </button>
              {[
          ...
          <motion.article className="soft-card mesh-panel relative h-[360px] overflow-hidden">
            ...
            <button className="absolute right-4 top-4 flex h-10 w-10 items-center justify-center rounded-xl bg-destructive text-white shadow-xl">
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="px-8 py-6 text-sm leading-8 text-foreground/80 text-justify">
                با انتخاب هر پرونده زیرمجموعه، کد نوسازی در اینپوت‌ها قرار
                می‌گیرد. سپس با جستجو، تمام سکشن‌ها با اطلاعات همان ملک پر
                می‌شوند.
              </div>
              <div className="px-8 pb-8">
                <button
                  onClick={() => setIsModalOpen(false)}
                  className="w-full rounded-2xl bg-emerald-600 py-3.5 text-sm font-bold text-white"
                >
                  فهمیدم
                </button>
              </div>

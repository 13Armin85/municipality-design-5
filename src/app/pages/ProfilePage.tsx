...
const contactInfo = [
  ...
  { icon: MapPin, label: 'نشانی', value: 'مراغه، خیابان شهید بهشتی، کوچه فرهنگ، پلاک ۲۱' },
];
          ...
          <div className="nav-shell">
            <div className="flex h-16 items-center justify-between gap-2 px-3 md:h-20 md:px-4">
              ...
              <div className="min-w-0 text-center">
                <h1 className="truncate text-sm font-bold text-foreground md:text-base">پروفایل من</h1>
              </div>

              <button type="button" onClick={toggleTheme} className="header-action-btn" aria-label="تغییر تم">
            ...
            >
              <div className="mb-5 text-center">
                <div className="relative mx-auto h-32 w-32 overflow-hidden rounded-[1.5rem] border border-border/80 bg-muted shadow-[0_16px_34px_rgba(4,20,17,0.16)]">
                  {profileImage ? (
                    <img src={profileImage} alt="عکس پروفایل کاربر" className="h-full w-full object-cover" />
                  ) : (
                ...
                <h3 className="mt-4 text-lg font-bold text-foreground">امیررضا محمدی</h3>
              ...
              <div className="mt-5 space-y-2">
                {accountCards.map((item) => (
                  <div key={item.title} className="flex items-center gap-3 rounded-xl border border-border/70 bg-card/70 p-3">
            ...
            <div className="grid grid-cols-1 gap-5">
              ...
              >
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <h3 className="text-base font-bold text-foreground md:text-lg">اطلاعات هویتی و حساب</h3>
                </div>
              ...
              >
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <h3 className="text-base font-bold text-foreground md:text-lg">اطلاعات تماس</h3>
                </div>

                <div className="space-y-2.5">
                  {contactInfo.map((item) => (
                    <div key={item.label} className="flex items-start gap-3 rounded-xl border border-border/70 bg-card/80 px-3 py-2.5">
              ...
              >
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <h3 className="text-base font-bold text-foreground md:text-lg">آخرین وضعیت درخواست‌ها</h3>
                </div>

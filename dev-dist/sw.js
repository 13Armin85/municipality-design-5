...
define(['./workbox-63ab604a'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    url
  }) => url.pathname === "/api" || url.pathname.startsWith("/api/") || url.pathname === "/dotnet10-api" || url.pathname.startsWith("/dotnet10-api/"), new workbox.NetworkOnly({
